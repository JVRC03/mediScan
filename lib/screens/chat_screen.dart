...
class ChatScreen extends StatefulWidget {
  final String data; // Accept the data from the previous screen
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    // Send the initial native data directly to the chatbot
    chatMessageController.sendMessage(widget.data + " give a bit compressed answer along with proper diet with multiple food options and health tips.", isUser: true);
...
Widget build(BuildContext context) {
  return Scaffold(
    ...
    appBar: AppBar(
      ...
      title: const Text("personalized bot"),
      backgroundColor: Colors.white,
    ),
    body: Stack(
      children: [
